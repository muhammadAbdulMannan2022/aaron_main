        ...
        <div className="p-6 space-y-6 max-w-lg w-full md:w-lg" >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-3">
                    <label className="block text-sm" style={{ color: "var(--color-text-primary)" }}>
                    ...
                    <div className="flex items-center gap-6">
                        <label className="flex items-center gap-2 cursor-pointer">
                            <div className="relative">
                                ...
                                />
                                <div
                                    className={`w-5 h-5 border-2 rounded flex items-center justify-center ${!createHappyPath ? " border-gray-500" : "border-gray-400"
                                        }`}
                                >
                                    {!createHappyPath && (
                ...
                <div className="flex gap-4 pt-4">
                    ...
                    <button
                        type="submit"
                        className="flex-1 px-6 py-3 rounded-lg font-medium transition-colors hover:opacity-90 hover:cursor-pointer"
                        style={{
                            backgroundColor: "var(--color-modal-button-bg)",
                            color: "var(--color-text-primary)",
                        }}
                    >
                        Confirm and submit
