                ...
                <div className="relative z-10 container mx-auto px-6 py-8">
                    ...
                    <div className="flex justify-end items-center mb-12">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-200 hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl hover:cursor-pointer border border-auth-button-bg text-auth-button-bg"
                        >
                            <Edit2 size={16} />
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 mx-auto">
                        ...
                        <div className="lg:col-span-1">
                            <div className="flex flex-col items-center text-center mb-8">
                                ...
                                {/* Name and Title */}
                                <h2 className="text-3xl md:text-4xl font-bold mb-2 text-auth-button-bg" >
                                    JACOB JONES
                                </h2>
                        ...
                        <div className="flex flex-col gap-4 md:col-span-2">
                            ...
                            <div className="h-fit backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-white/10 hover:bg-white/10 transition-all duration-300">
                                <h3 className="text-xl font-bold mb-4 text-auth-button-bg" >
                                    ABOUT
                                </h3>
                                <p className="text-gray-300 leading-relaxed">
                                    My name is <span className='text-auth-button-bg'>Jacob Jones</span>.
