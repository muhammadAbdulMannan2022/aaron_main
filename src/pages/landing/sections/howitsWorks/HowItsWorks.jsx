...
export function HowItsWorks() {
  const steps = [
    ...
    },
    {
      ...
      subTitle:
        "Detect inefficiencies, loops, waiting times, bottlenecks and process dropouts.",
    },
    {
      title: "Simulate",
      icon: <FaProjectDiagram className="text-[#A39DFF] text-2xl" />,
      subTitle:
        "Test potential changes with „what-if“ analysis and an assistent AI Chat Bot. ",
    },
    {
      title: "Optimize",
        ...
        <Slider {...settings} className="testimonial-carousel">
          {steps.map((item, index) => (
            <div key={index} className="h-[200px] px-3">
              <div className="flex flex-col items-start bg-black border border-gray-button-bg/50 text-white p-6 rounded-lg shadow-lg h-full">
                ...
                {/* pushes content to equal height */}
              </div>
            </div>
          ))}
        </Slider>
