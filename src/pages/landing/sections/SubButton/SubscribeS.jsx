function ShimmerButton() {
  ...
  return (
    <div className="flex items-center justify-center font-sans">
      ...
      <Link
        to="#priceing"
        className="relative inline-flex items-center justify-center p-[2.5px]  dark:bg-black rounded-full overflow-hidden group"
      >
        <div
          className="absolute inset-0"
          style={{
            background:
              "conic-gradient(from var(--angle), transparent 25%, #463CCB, transparent 50%)",
    ...
    <div className="bg-black/80 flex items-center justify-center py-10 md:py-20">
      <div className="max-w-7xl w-full bg-[#161616] rounded-2xl text-center gap-5 flex flex-col landing-shadow p-8 md:p-16 items-center justify-center py-10 md:py-28">
        ...
        <p className="max-w-3xl text-base text-gray-400">
          {" "}
          Discover inefficiencies, benchmark performance, and simulate future
          scenarios, all in one intuitive platform. Start unlocking real
          business impact with our Process Mining Software today.
        </p>
        <ShimmerButton />
      </div>
    </div>
