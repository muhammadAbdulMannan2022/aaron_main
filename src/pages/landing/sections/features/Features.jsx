...
export default function BenefitsSection() {
    ...
    return (
        <section className="py-16 px-6" style={{ backgroundColor: "var(--color-main-bg)" }}>
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg" style={{ color: "var(--color-text-notActive)" }}>
                ...
                <div className="flex flex-wrap items-stretch justify-center gap-5">
                    {benefits.map((benefit, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className="p-6 rounded-lg border w-full sm:w-1/2 md:w-[28%] flex-grow-0 flex-shrink-0 h-[150px] bg-black border-gray-button-bg"

                            >
                                <div className="flex items-start gap-4 h-full">
                                    <div
                                        className="p-3 rounded-lg flex-shrink-0 bg-gradient-to-tr from-[#090909] to-[#1F1F1F]"
                                    >
                                        <IconComponent size={24} style={{ color: "var(--color-landing-icon)" }} />
                                    </div>
